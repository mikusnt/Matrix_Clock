...
#define REGISTERS_DDR DDRD
//! rejestr stanu wejscia danych dla grupy rejestrow X
#define REGISTERS_PORT PORTD
...
#define X0_DATA_ADDR (1 << PD0)
//! ustawia wartosc wejscia danych dla rejestru X0 na HIGH
#define X0_DATA_HIGH() REGISTERS_PORT |= X0_DATA_ADDR
//! ustawia wartosc wejscia danych dla rejestru X0 na LOW
#define X0_DATA_LOW() REGISTERS_PORT &= ~X0_DATA_ADDR
...
#define X1_DATA_ADDR (1 << PD1)
//! ustawia wartosc wejscia danych dla rejestru X1 na HIGH
#define X1_DATA_HIGH() REGISTERS_PORT |= X1_DATA_ADDR
//! ustawia wartosc wejscia danych dla rejestru X1 na LOW
#define X1_DATA_LOW() REGISTERS_PORT &= ~X1_DATA_ADDR


//! adres wejscia danych dla arejestru X2
#define X2_DATA_ADDR (1 << PD2)
//! ustawia warosc wejscia danych dla rejestru X2 na HIGH
#define X2_DATA_HIGH() REGISTERS_PORT |= X2_DATA_ADDR
//! ustawia wartosc wejscia danych dla rejestru X2 na LOW
#define X2_DATA_LOW() REGISTERS_PORT &= ~X2_DATA_ADDR

/*
 *		X3
 */
//! adres wejscia danych dla rejestru X3
#define X3_DATA_ADDR (1 << PD3)
//! ustawia wartosc wejscia danych dla rejestru X3 na HIGH
#define X3_DATA_HIGH() REGISTERS_PORT |= X3_DATA_ADDR
//! ustawia wartosc wejscia danych dla rejestru X3 na LOW
#define X3_DATA_LOW() REGISTERS_PORT &= ~X3_DATA_ADDR

/*
 *		X_CLK
 */
//! adres zegara wejscia szeregowego dla rejestrow X
#define X_CLK_ADDR (1 << PD4)
//! ustawia wartosc zegara wejscia szeregowego dla rejestrow X na HIGH
#define X_CLK_HIGH() REGISTERS_PORT |= X_CLK_ADDR
//! ustawia wartosc zegara wejscia szeregowego dla rejestrow X na LOW
#define X_CLK_LOW() REGISTERS_PORT &= ~X_CLK_ADDR
...
#define Y_DATA_ADDR (1 << PD0)
//! ustawia wartosc wejscia danych dla rejestru Y na HIGH
#define Y_DATA_HIGH() REGISTERS_PORT |= Y_DATA_ADDR
//! ustawia wartosc wejscia danych dla rejestru Y na LOW
#define Y_DATA_LOW() REGISTERS_PORT &= ~Y_DATA_ADDR

/*
 *		Y_CLK
 */
//! adres zegara wejscia danych dla rejestru Y
#define Y_CLK_ADDR (1 << PD4)

/*
 *		LATCH
 */
//! adres zatrzasku wyjscia rowloleglego dla rejestrow X
#define LATCH_ADDR (1 << PD5)
//! ustawia wartosc zatrzasku wyjscia rownoleglego dla wszystkich rejestrow na HIGH
#define LATCH_HIGH() REGISTERS_PORT |= LATCH_ADDR
//! ustawia wartosc zatrzasku wyjscia rownloleglego dla wszystkich rejestrow na LOW
#define LATCH_LOW() REGISTERS_PORT &= ~LATCH_ADDR

/*
 *		Y_SW
 */
//! rejestr kierunku przelacznika stanu wyjscia rownoleglego dla rejestru Y
#define Y_SW_DDR DDRC
//! rejestr stanu przelacznika stanu wyjscia rownoleglego dla rejestru Y
#define Y_SW_PORT PORTC
//! adres przelacznika stanu wyjscia rownoleglego dla rejestru Y
#define Y_SW_ADDR (1 << PC3)
...
//! steruje stanem wszystkich wyjsc rownoleglych rejestru Y
...
inline void Y_CLK_01() {
	REGISTERS_PORT &= ~Y_CLK_ADDR;
	REGISTERS_PORT |= Y_CLK_ADDR;
}

inline void X_CLK_01() {
	REGISTERS_PORT &= ~X_CLK_ADDR;
	REGISTERS_PORT |= X_CLK_ADDR;
